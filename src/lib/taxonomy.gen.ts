...
export const TYPE_INFO: Record<string, TypeInfo> = {
  ...
  aspect: { label_es: 'Aspecto', mechanical_fields: ['rating_max', 'ratings'] },
  background: { label_es: 'Trasfondo', mechanical_fields: ['rating_max', 'ratings', 'scales', 'purchase_options'] },
  ...
  flaw: { label_es: 'Defecto', mechanical_fields: ['bonus', 'category', 'prerequisites', 'restriction'] },
  ...
  'hedge-path': { label_es: 'Senda de Hechicería', mechanical_fields: ['scales'] },
  ...
  merit: { label_es: 'Mérito', mechanical_fields: ['cost', 'category', 'restriction'] },
  'necromancy-path': { label_es: 'Senda de Nigromancia', mechanical_fields: ['discipline', 'path_note', 'levels'] },
  numen: { label_es: 'Numen', mechanical_fields: ['category', 'roll', 'difficulty', 'cost', 'duration', 'ratings'] },
